...
static const char *colors[SchemeLast][3]      = {
	/*               fg           bg           border   */
	[SchemeNorm] = { normfgcolor, normfgcolor, normbordercolor },
...
static const char *tags[] = {"dev", "term", "www", "im", "media", "screen", "build", "xmpp", "slack" };
...
static const Rule rules[] = {
	...
	{ "chromium-browser-chromium",  NULL,       NULL,       1 << 2,       0,           -1},
};
...
/* alsa */
static const char *upvol[]   = { "amixer", "-c", "1", "set", "Master", "1.5dB+", NULL };
static const char *downvol[] = { "amixer", "-c", "1", "set", "Master", "1.5dB-", NULL };
